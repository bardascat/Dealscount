...
class CategoriesModel extends AbstractModel  {
    ...
    public function addCategory($post) {
        ...
        $category->setSlug(\Dealscount\Util\NeoUtil::makeSlugs($post['category_name'] . '-' . $id));
    ...
    public function updateCategory($post) {
        try {
            ...
            $category->setName($post['category_name']);
            $category->setSlug(\Dealscount\Util\NeoUtil::makeSlugs($post['category_name'] . '-' . $post['id_category']));
    ...
    public function getRootCategories($item_type, $child = false, $orm = false) {
        ...
        if (!$orm) {
            ...
            $categories = $catRep->findBy(array("id_parent" => NULL, "item_type" => $item_type), array("position" => "asc"));
        }
